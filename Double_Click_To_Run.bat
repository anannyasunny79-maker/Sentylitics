...
if %errorlevel% neq 0 (
  if exist "C:\Users\Student\AppData\Local\Programs\R\R-4.6.1\bin\Rscript.exe" (
    set "RSCRIPT_CMD="C:\Users\Student\AppData\Local\Programs\R\R-4.6.1\bin\Rscript.exe""
  ) else (
    for /d %%D in ("C:\Users\Student\AppData\Local\Programs\R\R-*") do (
